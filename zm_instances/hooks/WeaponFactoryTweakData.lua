...
function WeaponFactoryTweakData:_init_multiplix()    
	...
	--COMMANDO 101
    self.wpn_fps_gre_ray_primary = deep_clone(self.wpn_fps_rpg7)
    self.wpn_fps_gre_ray_primary.unit = "new_weapon_units/wpn_fps_gre_ray_primary"
    self.wpn_fps_gre_ray_secondary = deep_clone(self.wpn_fps_rpg7)
    self.wpn_fps_gre_ray_secondary.unit = "new_weapon_units/wpn_fps_gre_ray_secondary"
    self.wpn_fps_gre_ray_primary_npc = deep_clone(self.wpn_fps_gre_ray_primary)
    self.wpn_fps_gre_ray_primary_npc.unit = "units/pd2_dlc_overkill_pack/weapons/wpn_fps_rpg7/wpn_fps_rpg7_npc"
    self.wpn_fps_gre_ray_secondary_npc = deep_clone(self.wpn_fps_gre_ray_secondary)
	self.wpn_fps_gre_ray_secondary_npc.unit = "units/pd2_dlc_overkill_pack/weapons/wpn_fps_rpg7/wpn_fps_rpg7_npc"
...
function WeaponFactoryTweakData:_init_upgraded_multiplix()
    ...
    self.wpn_fps_gre_ray_upg_primary = deep_clone(self.wpn_fps_rpg7)
    self.wpn_fps_gre_ray_upg_primary.unit = "new_weapon_units/upgrade/wpn_fps_gre_ray_upg_primary"
    self.wpn_fps_gre_ray_upg_secondary = deep_clone(self.wpn_fps_gre_ray_upg_primary)
    self.wpn_fps_gre_ray_upg_secondary.unit = "new_weapon_units/upgrade/wpn_fps_gre_ray_upg_secondary"
    self.wpn_fps_gre_ray_upg_primary_npc = deep_clone(self.wpn_fps_gre_ray_upg_primary)
    self.wpn_fps_gre_ray_upg_primary_npc.unit = "units/pd2_dlc_overkill_pack/weapons/wpn_fps_rpg7/wpn_fps_rpg7_npc"
    self.wpn_fps_gre_ray_upg_secondary_npc = deep_clone(self.wpn_fps_gre_ray_upg_secondary)
	self.wpn_fps_gre_ray_upg_secondary_npc.unit = "units/pd2_dlc_overkill_pack/weapons/wpn_fps_rpg7/wpn_fps_rpg7_npc"
